...
module game_beta_1 (
    ...
    output reg [9:0] debug_out_3,
    output reg [9:0] red_out,
    output reg [9:0] green_out,
    output reg [9:0] blue_out,
  ...
  wire [1-1:0] M_game_controlunit_dec_rst;
  wire [1-1:0] M_game_controlunit_dec_score;
  ...
  reg [10-1:0] M_game_controlunit_pointer_value;
  control_unit_9 game_controlunit (
    .clk(clk),
    .rst(rst),
    ...
    .pointer_value(M_game_controlunit_pointer_value),
    ...
    .dec_rst(M_game_controlunit_dec_rst),
    .dec_score(M_game_controlunit_dec_score)
  );
  ...
  wire [10-1:0] M_players_current_score_out;
  ...
  always @* begin
    ...
    M_game_controlunit_pointer_value = M_players_pointer_out;
    ...
    case (M_players_pointer_out[0+3-:4])
      4'h0: begin
        bitemask = 10'h000;
        user_input = 10'h000;
      end
    ...
    if (random_input == 2'h0) begin
      rand_tenbits = 10'h000;
    end else begin
      if (random_input == 2'h1) begin
        rand_tenbits = 10'h001;
      end else begin
        if (random_input == 2'h2) begin
          rand_tenbits = 10'h002;
        end else begin
    ...
    endcase
    debug_out = M_players_pointer_out;
    debug_out_2 = bitemask;
    debug_out_3 = user_input;
    red_out = M_players_row_red_out;
    green_out = M_players_row_green_out;
    blue_out = M_players_row_blue_out;
    dec_reset = M_game_controlunit_dec_rst;
    dec_score = M_game_controlunit_dec_score;
  end
endmodule
